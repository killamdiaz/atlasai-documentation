...
Large language models are powerful, but **they don’t naturally maintain durable, structured memory** across long, multi-session conversations.
AtlasMemory v2 is our approach to solving that: extracting high-signal memories, organizing them into a semantic + temporal graph, and using that structure to power **reliable retrieval** and **memory-aware reasoning**.
...
![Layer 1 — Atomic Memory Extraction](/images/research/layer-1-atomic-extraction.png)

---

## Layer 2 — Global Memory Graph

Once memories exist, we connect them into a **global semantic graph**.
Each memory becomes a node. Relationships become edges.
...
![Layer 2 — Global Memory Graph](/images/research/layer-2-memory-graph.png)
...
![Layer 3 — Temporal Engine](/images/research/layer-3-temporal-engine.png)
...
AtlasMemory retrieves using a **hybrid strategy** that combines:
...
![Layer 4 — Hybrid Search v2](/images/research/layer-4-hybrid-search.png)
...
Preferences change. Facts get corrected. New information supersedes old information.
...
![Layer 5 — Memory Repair Engine](/images/research/layer-5-memory-repair.png)

---

## Layer 6 — Memory-Aware Reasoning Engine

This is the reasoning loop that makes AtlasMemory feel consistent over time.
Every answer is produced from a **structured context packet** (not a raw dump).
...
![Layer 6 — Memory-Aware Reasoning Engine](/images/research/layer-6-memory-aware-reasoning.png)
